		...
		this.settingsOptions.next([
			{
				title: this.translate.instant(
					'setting-component.option-general-title'
				),
				open: true,
				items: [
					{
					...
					{
						icon: `assets/images/flags/${this.setting.language ||
							'gb'}.svg`,
						text: this.translate.instant(
			...
			{
				title: this.translate.instant(
					'setting-component.option-account-title'
				),
				open: false,
				items: [
					{
						...
						event: (data) =>
							this.openPage(EditProfileComponent, data)
					},
					{
						...
						event: (data) =>
							this.openPage(ChangePasswordComponent, data)
					},
					{
				...
				items: [
					{
						...
						event: (data) =>
							this.openPage(NotificationSettingsComponent, data)
					}
				]
			},
			{
				title: this.translate.instant(
					'setting-component.option-more-title'
				),
				open: false,
				items: [
					{
