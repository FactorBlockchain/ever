...
export class ChartsComponent implements OnInit {
	...
	/** get all charts data to display on charts page from the charts service */
	public ngOnInit() {
		this.barChart = this.chartsService.createBarChart(
			this.barCanvas.nativeElement
		);
		this.doughnutChart = this.chartsService.createDoughnutChart(
			this.doughnutCanvas.nativeElement
		);
		this.lineChart = this.chartsService.createLineChart(
			this.lineCanvas.nativeElement
		);
		this.pieChart = this.chartsService.createPieChart(
